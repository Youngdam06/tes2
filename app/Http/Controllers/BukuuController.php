...
class BukuuController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('petugass.bukuu.index', compact('buku'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('kelolaBukuu.index')->with('success', 'Buku berhasil disimpan.');
    }
    ...
    public function edit(string $id)
    {
        ...
        $kategori = Kategori::all();
        return view('petugass.bukuu.edit', compact('buku', 'kategori'));
    }
    ...
    public function update(Request $request, Buku $buku, string $id)
    {
        ...
        if ($updated) {
            return redirect()->route('kelolaBukuu.index')->with('success', 'Data berhasil diperbarui');
        } else {
            return redirect()->route('kelolaBukuu.index')->with('error', 'Gagal memperbarui data');
        }
    }
